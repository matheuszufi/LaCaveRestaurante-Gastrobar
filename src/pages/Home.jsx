...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Features */}
      <section className="py-24 px-4 bg-dark-950">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <motion.h2 variants={fadeUp} className="font-display text-3xl md:text-4xl lg:text-5xl font-normal text-white">
                Por que escolher a <span className="font-script text-gold-600">La Cave</span>?
              </motion.h2>
              <motion.p variants={fadeUp} custom={1} className="text-dark-300 text-lg mt-4 font-body leading-relaxed">
                Cada detalhe pensado para proporcionar uma experiência gastronômica completa.
              </motion.p>

              <motion.div variants={fadeUp} custom={2} className="mt-8 space-y-6 text-dark-300 font-body text-sm leading-relaxed">
                <div>
                  <p className="font-display text-base font-bold text-white uppercase tracking-wider mb-1">Localização</p>
                ...
                <div>
                  <p className="font-display text-base font-bold text-white uppercase tracking-wider mb-1">Funcionamento</p>
                  <p><strong>Almoço:</strong> Terça a sábado das 11:30 às 15:30</p>
                  <p><strong>Jantar:</strong> Terça a sábado das 16h às 00:30</p>
                </div>
                <hr className="border-t border-dark-700" />
              ...
              <motion.div variants={fadeUp} custom={3}>
                <Link to="/contato" className="inline-block mt-6 text-sm px-6 py-3 border border-gold-500 bg-transparent text-white rounded-none uppercase tracking-wider hover:bg-gold-500 hover:text-dark-950 transition-colors duration-300">
                  ENTRAR EM CONTATO
                </Link>
              </motion.div>
            </motion.div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            ...
            >
              ...
              <p className="font-body text-dark-300 text-sm leading-relaxed">
                Sempre uma atração musical diferente a partir das 21:00.
              </p>
            </motion.div>

            {/* Música ao Vivo à direita */}
            <motion.div
              initial={{ opacity: 0, x: 30 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
